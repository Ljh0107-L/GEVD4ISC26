...
void tensorCoreSymmetricRank2kPhase2(cublasHandle_t handle,
                 long int n,
                 long int k,
                 float alpha,
                 __half *Ah,
...
void tensorCoreSymmetricRank2kPhase3(cublasHandle_t handle,
                 long int n,
                 long int k,
                 float alpha,
                 float *A,
                 ...
                 long int nb)
{
  ...
  for (int i = length; i >= 0; i--)
  {
    ...
    if (nn % 8192 == 0)
    {
      tensorCoreSymmetricRank2kPhase2(handle,
                  nn,
                  k,
                  alpha,
                  Ah + offset,
              ...
              long int nb)
{
  if (n % 2 || k % 2)
  {
    ...
    tensorCoreSymmetricRank2kPhase3(handle, n, k, alpha, A_, lda_, B_, ldb_, beta, C_, ldc_, hwork, nb);
  ...
  {
    tensorCoreSymmetricRank2kPhase3(handle, n, k, alpha, A, lda, B, ldb, beta, C, ldc, hwork, nb);
  }
}
